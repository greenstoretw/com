...
import {
  ...
  onSnapshot,
  query,
} from "firebase/firestore"; // 引入 Firestore 相關模組

// --- Firebase 配置 (已更新為您提供的設定) ---
...
const translations = {
  "zh-TW": {
    ...
    // turnstileFailed: '人機驗證失敗，請重試。', // 已移除 Turnstile 相關翻譯
    dashboardTitle: "儀表板",
    welcomeMessage: "歡迎，",
  ...
  en: {
    ...
    protectedContent:
      "This is protected content, only visible after logging in.",
    ...
    newsletterSubtitle:
      "Get the latest sustainable store information, eco-friendly living tips, and special offers",
    newsletterPlaceholder: "Your email",
    subscribeBtn: "Subscribe",
    newsletterSuccess:
      "Thank you for subscribing! You will receive our latest news.",
  ...
  fr: {
    ...
    loginFailed:
      "Échec de la connexion, veuillez vérifier l'e-mail ou le mot de passe.",
    registerSuccess: "Inscription réussie ! Veuillez vous connecter.",
    registerFailed: "Échec de l'inscription : ",
    missingFields: "Veuillez remplir tous les champs.",
    turnstileFailed: "Échec de la vérification humaine, veuillez réessayer.",
    dashboardTitle: "Tableau de bord",
    welcomeMessage: "Bienvenue, ",
    protectedContent:
      "Ceci est un contenu protégé, visible uniquement après connexion.",
    ...
    newsletterSubtitle:
      "Recevez les dernières informations sur les magasins durables, des conseils de vie écologique et des offres spéciales",
    newsletterPlaceholder: "Votre e-mail",
    subscribeBtn: "S'abonner",
    newsletterSuccess:
      "Merci de votre abonnement ! Vous recevrez nos dernières nouvelles.",
    ...
    storeTypePlaceholder:
      "Entrez le type de magasin (ex : Alimentation, Vêtements)",
  ...
  de: {
    ...
    loginFailed:
      "Anmeldung fehlgeschlagen, bitte überprüfen Sie E-Mail oder Passwort.",
    registerSuccess: "Registrierung erfolgreich! Bitte melden Sie sich an.",
    registerFailed: "Registrierung fehlgeschlagen: ",
    missingFields: "Bitte füllen Sie alle Felder aus.",
    turnstileFailed:
      "Menschliche Überprüfung fehlgeschlagen, bitte versuchen Sie es erneut.",
    dashboardTitle: "Dashboard",
    welcomeMessage: "Willkommen, ",
    protectedContent:
      "Dies ist geschützter Inhalt, nur nach Anmeldung sichtbar.",
    ...
    newsletterSubtitle:
      "Erhalten Sie die neuesten Informationen zu nachhaltigen Geschäften, umweltfreundliche Lebenstipps und Sonderangebote",
    newsletterPlaceholder: "Ihre E-Mail-Adresse",
    subscribeBtn: "Abonnieren",
    newsletterSuccess:
      "Vielen Dank für Ihr Abonnement! Sie erhalten unsere neuesten Nachrichten.",
  ...
  es: {
    ...
    loginFailed:
      "Error de inicio de sesión, compruebe el correo electrónico o la contraseña.",
    ...
    turnstileFailed:
      "La verificación humana falló, por favor, inténtelo de nuevo.",
    dashboardTitle: "Panel de Control",
    welcomeMessage: "Bienvenido, ",
    protectedContent:
      "Este es contenido protegido, solo visible después de iniciar sesión.",
    ...
    newsletterSubtitle:
      "Recibe la última información sobre tiendas sostenibles, consejos de vida ecológica y ofertas especiales",
    newsletterPlaceholder: "Tu correo electrónico",
    subscribeBtn: "Suscribirse",
    newsletterSuccess:
      "¡Gracias por suscribirte! Recibirás nuestras últimas noticias.",
    newsletterInvalidEmail:
      "Por favor, introduce una dirección de correo electrónico válida.",
    newsletterError:
      "Error al suscribirse, por favor, inténtalo de nuevo más tarde.",
    ...
    storeDescriptionPlaceholder:
      "Introduzca una breve descripción de la tienda",
  ...
  la: {
    ...
    loginFailed:
      "Initium defecit, quaeso epistulam electronicam vel tesseram verifica.",
    ...
    protectedContent:
      "Hoc est contentum protectum, solum post initium visibile.",
    goToLogin: "Ad Log In",
    ...
    newsletterSubtitle:
      "Accipe recentissimas informationes de copiia sustentabilibus, consilia vitae naturae amicae, et oblationes speciales",
    newsletterPlaceholder: "Tua epistula electronica",
    subscribeBtn: "Subscribere",
    newsletterSuccess:
      "Gratias tibi pro subscriptione! Nuntios nostros recentissimos accipies.",
    newsletterInvalidEmail:
      "Quaeso, inscriptionem electronicam validam inscribe.",
    ...
    storeTypePlaceholder:
      "Intra typum copiae (exempli gratia: Cibus, Vestimenta)",
  ...
  ja: {
    ...
    welcomeMessage: "ようこそ、",
    protectedContent:
      "これは保護されたコンテンツであり、ログイン後にのみ表示されます。",
    goToLogin: "ログインへ",
    goToRegister: "登録へ",
    ...
    newsletterSubtitle:
      "最新のサステナブルショップ情報、エコライフのヒント、特別オファーを受け取る",
...
function MessageModal({ message, onClose, currentLang }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity50 z-[2000] flex items-center justify-center">
...
function Login({ setRoute, currentLang }) {
  ...
  // const [loginTurnstileToken, setLoginTurnstileToken] = useState(null); // 已移除 Turnstile 相關狀態
  const [message, setMessage] = useState("");

  // 已移除 Turnstile 相關回調函數
  // const onLoginTurnstileSuccess = (token) => { setLoginTurnstileToken(token); };
  // const onLoginTurnstileExpired = () => { setLoginTurnstileToken(null); if (window.turnstile) { window.turnstile.reset('#login-turnstile-widget'); } };
  ...
  const handleSubmit = async (e) => {
    ...
    //     setMessage(translations[currentLang].turnstileFailed);
    //     return;
    // }

    try {
      // 已移除 Turnstile 密鑰驗證的 fetch 請求
      // const turnstileVerificationResponse = await fetch('https://challenges.cloudflare.com/turnstile/v0/siteverify', { /* ... */ });
      // const turnstileVerificationResult = await turnstileVerificationResponse.json();
      // if (!turnstileVerificationResult.success) { /* ... */ return; }
      ...
      setPassword("");
      // 已移除 Turnstile 重置
      // if (window.turnstile) { window.turnstile.reset('#login-turnstile-widget'); setLoginTurnstileToken(null); }
    } catch (error) {
  ...
  // 已移除 Turnstile 渲染的 useEffect
  // useEffect(() => { /* ... */ }, [CLOUDFLARE_SITE_KEY]);

  return (
    <section
      id="login"
      className="py-12 bg-gray-100 min-h-screen flex items-center justify-center"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-center mb-6">
            {translations[currentLang].loginTitle}
          </h2>
          <form onSubmit={handleSubmit}>
            ...
            {/* 已移除 Turnstile 小工具的 div */}
            {/* <div id="login-turnstile-widget" className="cf-turnstile mb-6"></div> */}
            <div className="flex items-center justify-between">
              ...
              >
                {translations[currentLang].noAccountYet}{" "}
                {translations[currentLang].goToRegister}
              </button>
            </div>
          </form>
        </div>
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-center mb-6">
            {translations[currentLang].registerTitle}
          </h2>
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-block align-baseline font-bold text-sm text-green-600 hover:text-green-800"
              >
                {translations[currentLang].alreadyHaveAccount}{" "}
                {translations[currentLang].goToLogin}
              </button>
            </div>
          </form>
        </div>
...
function Dashboard({ setRoute, currentLang }) {
  ...
  return (
    <section id="dashboard" className="py-12 bg-green-50 min-h-screen">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
          ...
          <p className="text-xl text-gray-700 mb-4 text-center">
            ...
            <span className="font-semibold">
              {currentUser ? currentUser.email : "訪客"}
            </span>
            !
          </p>
          <p className="text-gray-600 mb-8 text-center">
            {translations[currentLang].protectedContent}
          </p>

          {/* 新增商店表單 */}
          <div className="mb-12">
            <h3 className="text-2xl font-bold mb-4">
              {translations[currentLang].addStoreTitle}
            </h3>
            <form
            ...
            >
              <div>
                <label
                  ...
                  className="block text-gray-700 text-sm font-bold mb-2"
                >
                  {translations[currentLang].storeNameLabel}
                </label>
                <input
                  type="text"
                  id="storeName"
              ...
              <div>
                <label
                  ...
                  className="block text-gray-700 text-sm font-bold mb-2"
                >
                  {translations[currentLang].storeAddressLabel}
                </label>
                <input
                  type="text"
                  id="storeAddress"
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  placeholder={
                    translations[currentLang].storeAddressPlaceholder
                  }
                  value={storeAddress}
              ...
              <div>
                <label
                  ...
                  className="block text-gray-700 text-sm font-bold mb-2"
                >
                  {translations[currentLang].storeTypeLabel}
                </label>
                <input
                  type="text"
                  id="storeType"
              ...
              <div className="md:col-span-2">
                <label
                  ...
                  className="block text-gray-700 text-sm font-bold mb-2"
                >
                  {translations[currentLang].storeDescriptionLabel}
                </label>
                <textarea
                  id="storeDescription"
                  rows="3"
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  placeholder={
                    translations[currentLang].storeDescriptionPlaceholder
                  }
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4">
              {translations[currentLang].storeListTitle}
            </h3>
            {stores.length === 0 ? (
              <p className="text-gray-600 text-center">
                {translations[currentLang].noStoresYet}
              </p>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {stores.map((store) => (
                  ...
                  >
                    ...
                    <p className="text-gray-700 text-sm">{store.type}</p>
...
export default function App() {
  ...
  const renderNavbar = () => (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <a
            ...
            onClick={() => setRoute("login")}
          >
            {translations[currentLang].appName}
          </a>
        </div>
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <select
            ...
            value={currentLang}
            className="bg-green-500 text-white text-sm px-3 py-1 rounded-full hover:bg-green-700 transition cursor-pointer"
          >
        ...
        <div className="md:hidden flex items-center">
          <select
            ...
            onChange={handleLanguageChange}
            value={currentLang}
            className="bg-green-500 text-white text-sm px-3 py-1 rounded-full hover:bg-green-700 transition cursor-pointer mr-2"
          >
            <option value="zh-TW">{translations["zh-TW"].langChinese}</option>
            <option value="en">{translations["en"].langEnglish}</option>
            <option value="fr">{translations["fr"].langFrench}</option>
          ...
          <button id="menu-toggle" className="text-gray-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
      ...
      <div id="mobile-menu" className="hidden md:hidden px-4 py-2 bg-white">
        <button
          onClick={() => setRoute("login")}
        ...
        {({ currentUser, loading }) => {
          ...
          if (currentUser) {
            ...
            switch (currentRoute) {
              case "register":
                return (
                  <Register setRoute={setRoute} currentLang={currentLang} />
                );
              case "login":
              default:
